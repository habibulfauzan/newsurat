...
<ul class="navbar-nav bg-gray-900 sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('HalamanDashboard/masyarakat'); ?>">
    ...
    <!-- Nav Item - Dashboard -->
    <li class="nav-item">
        <a class="nav-link" href="<?= base_url('HalamanDashboard/masyarakat'); ?>">
    ...
    <li class="nav-item">
        <a class="nav-link" href="charts.html">
            <i class="far fa-fw fa-address-card"></i>
            <span>Surat Ket. Kematian</span></a>
    </li> -->
    ...
    <!-- Nav Item - Dashboard -->
    <li class="nav-item">
        <a class="nav-link" href="<?= base_url('RiwayatPengajuanSurat') ?>">
